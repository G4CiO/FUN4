...
static const _ShowConfig_Request_type_support_symbol_names_t _ShowConfig_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fun4_interfaces, srv, ShowConfig_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fun4_interfaces, srv, ShowConfig_Request)),
  }
};
...
{
  return &::fun4_interfaces::srv::rosidl_typesupport_cpp::ShowConfig_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fun4_interfaces, srv, ShowConfig_Request)() {
  return get_message_type_support_handle<fun4_interfaces::srv::ShowConfig_Request>();
}
...
static const _ShowConfig_Response_type_support_symbol_names_t _ShowConfig_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fun4_interfaces, srv, ShowConfig_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fun4_interfaces, srv, ShowConfig_Response)),
  }
};
...
{
  return &::fun4_interfaces::srv::rosidl_typesupport_cpp::ShowConfig_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fun4_interfaces, srv, ShowConfig_Response)() {
  return get_message_type_support_handle<fun4_interfaces::srv::ShowConfig_Response>();
}
...
static const _ShowConfig_type_support_symbol_names_t _ShowConfig_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fun4_interfaces, srv, ShowConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fun4_interfaces, srv, ShowConfig)),
  }
};
...
{
  return &::fun4_interfaces::srv::rosidl_typesupport_cpp::ShowConfig_service_type_support_handle;
}

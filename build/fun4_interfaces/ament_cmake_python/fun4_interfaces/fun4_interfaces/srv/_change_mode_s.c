...
bool fun4_interfaces__srv__change_mode__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fun4_interfaces.srv._change_mode.ChangeMode_Request", full_classname_dest, 51) == 0);
  }
  fun4_interfaces__srv__ChangeMode_Request * ros_message = _ros_message;
  {  // mode
...
PyObject * fun4_interfaces__srv__change_mode__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fun4_interfaces.srv._change_mode");
...
ROSIDL_GENERATOR_C_EXPORT
bool fun4_interfaces__srv__change_mode__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {

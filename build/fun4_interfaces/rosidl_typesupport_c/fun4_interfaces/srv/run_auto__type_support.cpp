...
static const _RunAuto_Request_type_support_symbol_names_t _RunAuto_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fun4_interfaces, srv, RunAuto_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fun4_interfaces, srv, RunAuto_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fun4_interfaces, srv, RunAuto_Request)() {
  return &::fun4_interfaces::srv::rosidl_typesupport_c::RunAuto_Request_message_type_support_handle;
}
...
static const _RunAuto_Response_type_support_symbol_names_t _RunAuto_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fun4_interfaces, srv, RunAuto_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fun4_interfaces, srv, RunAuto_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fun4_interfaces, srv, RunAuto_Response)() {
  return &::fun4_interfaces::srv::rosidl_typesupport_c::RunAuto_Response_message_type_support_handle;
}
...
static const _RunAuto_type_support_symbol_names_t _RunAuto_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fun4_interfaces, srv, RunAuto)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fun4_interfaces, srv, RunAuto)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, fun4_interfaces, srv, RunAuto)() {
  return &::fun4_interfaces::srv::rosidl_typesupport_c::RunAuto_service_type_support_handle;
}

...
class Init_RunAuto_Request_reach_target
{
public:
  Init_RunAuto_Request_reach_target()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::fun4_interfaces::srv::RunAuto_Request reach_target(::fun4_interfaces::srv::RunAuto_Request::_reach_target_type arg)
  {
...
{
  return fun4_interfaces::srv::builder::Init_RunAuto_Request_reach_target();
}
...
class Init_RunAuto_Response_target
{
public:
  Init_RunAuto_Response_target()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::fun4_interfaces::srv::RunAuto_Response target(::fun4_interfaces::srv::RunAuto_Response::_target_type arg)
  {
...
{
  return fun4_interfaces::srv::builder::Init_RunAuto_Response_target();
}

...
#include "fun4_interfaces/srv/detail/change_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fun4_interfaces::srv::ChangeMode_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fun4_interfaces::srv::ChangeMode_Request & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fun4_interfaces::srv::ChangeMode_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fun4_interfaces::srv::ChangeMode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fun4_interfaces::srv::ChangeMode_Request *>(
    untyped_ros_message);
...
{
  return &fun4_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fun4_interfaces, srv, ChangeMode_Request)() {
  return &fun4_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const fun4_interfaces::srv::ChangeMode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<fun4_interfaces::srv::ChangeMode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &fun4_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fun4_interfaces, srv, ChangeMode_Response)() {
  return &fun4_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode_Response__handle;
}
...
{
  return &fun4_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fun4_interfaces, srv, ChangeMode)() {
  return &fun4_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode__handle;
}
